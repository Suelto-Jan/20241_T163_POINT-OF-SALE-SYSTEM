...
import { Bar } from 'recharts'; // Importing Recharts' Bar chart component
import { ResponsiveContainer, XAxis, YAxis, Tooltip, Legend, CartesianGrid, BarChart } from 'recharts';
...
function TotalSales() {
  ...
  const handleExportToExcel = () => {
    ...
    const salesDetailsRows = data.salesDetails.map(item => [
      ...
      item.productId || 'N/A',
      `${item.quantitySold || 0}/${item.quantityAvailable || 0}`, // Display as fraction
